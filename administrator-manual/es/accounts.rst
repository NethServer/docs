...
    guión bajo (_) y debe comenzar con una letra minúscula.
...
El :index:`contraseña` es un conjunto de condiciones minimas que debe coincidir con la contraseña que tiene que ser aceptado por el sistema. 
...
El :index:`fuerte` requiere que la contraseña debe cumplir con las siguientes reglas:
...
.. note:: 
       El sistema se referirá a la fecha del último cambio de contraseña, 
       cualquiera que sea anterior más de 6 meses, el servidor enviará un correo
       electrónico para indicar que la contraseña ha caducado.  
