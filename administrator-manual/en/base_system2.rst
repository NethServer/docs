...
Two-factor authentication (2FA) is an (optional) extra layer of security required to access the new Server Manager.
...
under :guilabel:`Settings` page, then follow these steps:
