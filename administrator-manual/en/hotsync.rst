...
.. hint::
   ...
   If you have configured slave host before November 2020, update the package to release 2.2.0 on master and slave with *yum update -y nethserver-hotsync --enablerepo=nethforge* or from Software Center.
