...
|product| viene configurato tramite una :index:`interfaccia web`, per accedere
...
Nella barra degli indirizzi digitare: ``https://a.b.c.d:980`` oppure ``https://server:980``
